...
Status: `PROCESS / NOT A MANUSCRIPT`
Venue: IEEE T-ASE
Companion: `docs/superpowers/specs/2026-08-19-tase-submission-programme.md`

Every later experiment must map to a row below. A result that cannot be
placed is either a limitation or a different paper.

## Allowed Paper A claims (after P1–P4 close)
...
| --- | --- |
| TX1 | G6-B eight-dimension gate passed |
| TX2 | The six article-core cases are held-out confirmation |
| TX3 | A2b is necessary for local deadlock |
| TX4 | Complete-LTS admission is a general structural theorem |
| TX5 | Every local core is `D_local` |
| TX6 | `D_local` is a plant terminal SCC |
| TX7 | Exact/DES agreement proves the theorem or plant fidelity |
| TX8 | H4 v2 demonstrates manufacturing deadlock risk |
| TX9 | First reachable partial-deadlock certificate / first siphon-free detector |
| TX10 | General IMS ≡ S3PR / general finite-capacity iff threshold |
| TX11 | G5 failures are superseded |
| TX12 | The method improves throughput in a real factory |

## Where each work package feeds

- P1 feeds TA1, TA6, and the Practitioner outline.
- P2 feeds TA9, TA10.
- P3 feeds no new theorem; it feeds T-ASE “computational evidence”.
- P4 feeds every allowed claim’s related-work sentence.
- P5 packages TA1–TA10; it must not introduce TX1–TX12.
