...
| G-IEEE-BODY | P5 | **full-proof draft** | `TASE_LOCAL_FIRST_HIT_MANUSCRIPT.md` now contains complete P1–P4 / A2b / siphon / committor derivations plus BIX appendices | IEEE two-column conversion later |
